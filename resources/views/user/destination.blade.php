...
@endauth
    ...
    <div class="travel-destination container-fluid">
        <div class="container">
           <input type="search" placeholder="Search" class="record-search mb-3 p-2 w-100" name="search" id="search" onkeyup="searchTable()">
            <div class="destination-row row" id="mytable">
                @forelse($destinations as $destination)
                
                <div class="col-md-3 descol mytr">
                <a href="{{url('/destination',$destination->country->sortname)}}">
                   <div class="destcol">
                       <img src="{{asset('destinationImage/'.$destination->image)}}" alt="" style="height:300px;width:300px;">
                       <div class="layycover">
<h4>{{$destination->country->sortname}}</h4> <span class="badge badge-info" style="margin-left:10px;">{{$destination->packages->count()}} Places</span>
                       </div>
                   </div>
                   </a>
                </div>
             ...
             @empty
             <p class="text-center">No Available Destinations.</p>
             @endforelse
                </div>
            </div>
        </div>
